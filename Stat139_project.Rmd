...
#marriage
levels(df_adult$marriage) = c("married/living_with_partner", "widowed", "divorced/separated", "divorced/separated", "never_married", "married/living_with_partner")


#tv_hrs
levels(df_adult$famincome) = c("1hr_or_less","1hr_or_less", "2-4hrs", "2-4hrs" , "2-4hrs", "5hrs_or_more", "0hr")
...
```{r fig.height=10, fig.width=9, fig.align="center", warning=FALSE}
...
```{r fig.height=10, fig.width=10, fig.align="center", warning=FALSE}
plot1 = ggplot(df_adult, aes(x=age, y=log(bmi))) + geom_point() + 
  ggtitle("Age")
plot3 = ggplot(df_adult, aes(x=famsize, y=log(bmi))) + geom_point() + 
  ggtitle("Family Size")
plot4 = ggplot(df_adult, aes(x=alcoholfrq, y=log(bmi))) + geom_point() + 
  ggtitle("Frequency of Alcohol Consumption")
plot5 = ggplot(df_adult, aes(x=grocery, y=log(bmi))) + geom_point() + 
  ggtitle("Money Spent on Grocery")
plot6 =ggplot(df_adult, aes(x=eatout, y=log(bmi))) + geom_point() + 
  ggtitle("Money Spent Eating Out")
plot7 = ggplot(df_adult, aes(x=delivery, y=log(bmi))) + geom_point() + 
  ggtitle("Money Spent on Delivered Food")
plot8 =ggplot(df_adult, aes(x=meals_nothome, y=log(bmi))) + geom_point() + 
  ggtitle("Number of Meals Not Home Prepared")
plot9 = ggplot(df_adult, aes(x=meals_fastfood, y=log(bmi))) + geom_point() + 
  ggtitle("Number of Fast Food Meals")
plot10 = ggplot(df_adult, aes(x=sleep_hr, y=log(bmi))) + geom_point() + 
  ggtitle("Hours of Sleep")
grid.arrange(plot1, plot3, plot4, plot5, plot6, plot7, plot8, plot9, plot10, ncol=3)
```          
...
```{r fig.height=10, fig.width=10, fig.align="center", warning=FALSE}
plot1 = ggplot(df_adult, aes(x=age, y=log(bmi), colour=gender)) + geom_point() + 
  ggtitle("Age")
plot3 = ggplot(df_adult, aes(x=famsize, y=log(bmi), colour=gender)) + geom_point() + 
  ggtitle("Family Size")
plot4 = ggplot(df_adult, aes(x=log(alcoholfrq), y=log(bmi), colour=gender)) + geom_point() + 
  ggtitle("Frequency of Alcohol Consumption")
plot5 = ggplot(df_adult, aes(x=grocery, y=log(bmi), colour=gender)) + geom_point() + 
  ggtitle("Money Spent on Grocery")
plot6 =ggplot(df_adult, aes(x=eatout, y=log(bmi), colour=gender)) + geom_point() + 
  ggtitle("Money Spent Eating Out")
plot7 = ggplot(df_adult, aes(x=delivery, y=log(bmi), colour=gender)) + geom_point() + 
  ggtitle("Money Spent on Delivered Food")
plot8 =ggplot(df_adult, aes(x=meals_nothome, y=log(bmi), colour=gender)) + geom_point() + 
  ggtitle("Number of Meals Not Home Prepared")
plot9 = ggplot(df_adult, aes(x=meals_fastfood, y=log(bmi), colour=gender)) + geom_point() + 
  ggtitle("Number of Fast Food Meals")
plot10 = ggplot(df_adult, aes(x=sleep_hr, y=log(bmi), colour=gender)) + geom_point() + 
  ggtitle("Hours of Sleep")
grid.arrange(plot1, plot3, plot4, plot5, plot6, plot7, plot8, plot9, plot10, ncol=3)
```          
