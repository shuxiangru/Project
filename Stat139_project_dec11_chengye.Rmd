...
form =  update.formula(formula(model1c), bmi_class~.)

multinomial_model = multinom(form, data=df_adult)

mean(predict(multinomial_model, newdata = df_adult, "class") == df_adult$bmi_class)
