...
model2 = lm(log.weight~(gender+age+race+edu+marriage+famsize+famincome+alcohol12yr+alcoholfrq+grocery+eatout+delivery+milk+meals_nothome+meals_fastfood+depressed+sleep_trouble+tv_hrs+sleep_hr+smoke)^2, data = df_adult)
summary(model2)
extractAIC(model2)
```
