...
plot2 = ggplot(df_adult, aes(x=famsize, y=log2bmi)) + geom_point() + 
  ggtitle("Family Size")
plot3 = ggplot(df_adult, aes(x=alcoholfrq, y=log2bmi)) + geom_point() + 
  ggtitle("Frequency of Alcohol Consumption")
plot4 = ggplot(df_adult, aes(x=grocery, y=log2bmi)) + geom_point() + 
  ggtitle("Money Spent on Grocery")
plot5 =ggplot(df_adult, aes(x=eatout, y=log2bmi)) + geom_point() + 
  ggtitle("Money Spent Eating Out")
plot6 = ggplot(df_adult, aes(x=delivery, y=log2bmi)) + geom_point() + 
  ggtitle("Money Spent on Delivered Food")
