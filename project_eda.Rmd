...
```{r fig.height=9, fig.width=10, fig.align="center", warning=FALSE}
df_adult$log2alcoholfrq = log(log(df_adult$alcoholfrq + 1))
...
plot2 = ggplot(df_adult, aes(x=famsize, y=log2bmi)) + geom_point() + 
  ggtitle("Family Size")
plot3 = ggplot(df_adult, aes(x=log2alcoholfrq, y=log2bmi)) + geom_point() + 
  ggtitle("Frequency of Alcohol Consumption")
...
plot2 = ggplot(df_adult, aes(x=famsize, y=log2bmi, colour=edu)) + geom_point() + 
  ggtitle("Family Size")
plot3 = ggplot(df_adult, aes(x=log2alcoholfrq, y=log2bmi, colour=edu)) + geom_point() + 
  ggtitle("Frequency of Alcohol Consumption")
